...
class AliceTranslations {
  ...
  static AliceTranslationData _buildEnTranslations() {
    return AliceTranslationData(
      languageCode: "en",
      values: {
        AliceTranslationKey.alice: "vm-log-api",
        AliceTranslationKey.callDetails: "HTTP Call Details",
        AliceTranslationKey.emailSubject: "vm-log-api report",
        ...
        AliceTranslationKey.saveHeaderTitle: "vm-log-api - HTTP Inspector",
  ...
  static AliceTranslationData _buildPlTranslations() {
    return AliceTranslationData(
      ...
      values: {
        ...
        AliceTranslationKey.emailSubject: "Raport vm-log-api",
        ...
        AliceTranslationKey.saveHeaderTitle: "vm-log-api - Inspektor HTTP",
